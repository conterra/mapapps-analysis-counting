...
define(["dojo/_base/declare",
    ...
    return declare([BuilderWidget, _TemplatedMixin, _WidgetsInTemplateMixin, _CssStateMixin, _Connect], {
        ...
        i18n: {
            ...
            hint: {
                message: "Please specify where search stores"
            }
        },
        postCreate: function (opts) {
            ...
            model.set("selectedIds", this.config.properties && this.config.properties.whereStoreIds ? this.config.properties.whereStoreIds : []);
