 ...
 */
define(["dojo/_base/lang", "dojo/_base/declare", "dojo/_base/array", "ct/_lang", "ct/_Connect", "ct/array", "ct/Exception", "ct/_string", "./WhatStoreSelectionWidget", "ct/store/ComplexMemory", "ct/_when"],
    function (d_lang, declare, d_array, ct_lang, _Connect, ct_array, Exception, ct_string, WhatStoreSelectionWidget, ComplexMemoryStore, ct_when) {
        return declare([_Connect],
            {
                createInstance: function () {
                    var configStore = this._getConfigStore();
                    var i18n = this._i18n.get().ui.whatStoreSelection;
                    ...
                    var widget = this._widget = new WhatStoreSelectionWidget(opts);
